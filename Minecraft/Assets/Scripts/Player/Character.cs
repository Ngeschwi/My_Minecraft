...
public class Character : MonoBehaviour
{
    ...
    private void Update()
    {
        if (fly)
        {
            ...
            playerMovement.Fly(playerInput.MouvementInput, playerInput.IsJumping, playerInput.RunningPressed);
        }
        else
        {
            ...
            animator.SetFloat("speed", playerInput.MouvementInput.magnitude);
            playerMovement.HandleGravity(playerInput.IsJumping);
            playerMovement.Walk(playerInput.MouvementInput, playerInput.RunningPressed);
        }
    }
